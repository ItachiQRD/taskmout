...
export default function SavoirPlusPage() {
  return (
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <section className="border-b border-white/10 py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <AnimateSection>
            ...
            <p className="section-animate mt-6 text-cream/80 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <AnimateSection>
            ...
            <div className="mt-12 space-y-8 sm:space-y-10">
              {/* Argan — image gauche */}
              <div className="section-animate-item flex flex-col sm:flex-row gap-6 sm:gap-8 items-stretch p-5 rounded-2xl bg-white/5 border border-white/10 transition-all duration-300 hover:border-argan-400/30">
                <div className="relative w-full sm:w-48 shrink-0 aspect-square rounded-xl overflow-hidden bg-white/5">
              ...
              {/* Olive — image droite */}
              <div className="section-animate-item flex flex-col sm:flex-row-reverse gap-6 sm:gap-8 items-stretch p-5 rounded-2xl bg-white/5 border border-white/10 transition-all duration-300 hover:border-olive-400/30">
                <div className="relative w-full sm:w-48 shrink-0 aspect-square rounded-xl overflow-hidden bg-white/5">
                  <Image src={IMG('huile-olive.png')} alt="Huile d'olive Taskmout" fill className="object-cover" sizes="(max-width: 640px) 100vw, 192px" />
                </div>
                <div className="flex-1 sm:border-r-4 sm:border-olive-400/50 sm:pr-4 sm:text-right flex flex-col justify-center">
              ...
              <div className="section-animate-item p-6 sm:p-8 rounded-2xl bg-white/5 border border-white/10 border-l-4 border-l-argan-500/30 transition-all duration-300 hover:border-l-argan-400/60 text-center max-w-3xl mx-auto">
              ...
              {/* Amlou — image droite */}
              <div className="section-animate-item flex flex-col sm:flex-row-reverse gap-6 sm:gap-8 items-stretch p-5 rounded-2xl bg-white/5 border border-white/10 transition-all duration-300 hover:border-argan-400/30">
                <div className="relative w-full sm:w-48 shrink-0 aspect-square rounded-xl overflow-hidden bg-white/5">
                  <Image src={IMG('amlou-cacahuetes.png')} alt="Amlou Taskmout" fill className="object-cover" sizes="(max-width: 640px) 100vw, 192px" />
                </div>
                <div className="flex-1 sm:border-r-4 sm:border-argan-500/50 sm:pr-4 sm:text-right flex flex-col justify-center">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <AnimateSection>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <ul className="section-animate-item space-y-4 text-cream/85 max-w-md">
                <li className="flex gap-3 items-start p-4 rounded-xl bg-white/5 border border-white/10 transition-all duration-300 hover:border-argan-400/30">
      ...
      <section className="py-16 sm:py-24 border-b border-white/10 bg-[radial-gradient(ellipse_at_center,_rgba(214,139,42,0.06),_transparent_60%)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <AnimateSection>
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="section-animate font-display text-2xl sm:text-3xl md:text-4xl font-semibold text-cream tracking-tight">
            ...
            {/* Empilement — mobile */}
            <div className="md:hidden mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2 flex justify-center mt-2">
                <div className="relative w-40 h-40 rounded-full overflow-hidden ring-2 ring-argan-400/40 shadow-warm">
                  <Image
                    src={IMG('huile-miracle-soins-cheveux.png')}
                    alt="Huile Miracle Taskmout — soins du corps"
                    fill
          ...
          <AnimateSection>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="section-animate mt-4 text-cream/80 leading-relaxed">
                ...
                Survolez une image pour afficher la recette en détail.
              </p>
            </div>
