...
export default function MentionsPage() {
  return (
    <div className="min-h-screen bg-maison-creme">
      <section className="border-b border-maison-brun/10 py-16 sm:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <AnimateSection>
            <div className="section-animate inline-flex items-center gap-2 px-4 py-2 rounded-full border border-maison-brun/25 bg-maison-sable/30 text-maison-cacao/90 text-sm">
              <ShieldCheck className="w-4 h-4 text-maison-brun" />
              Informations légales
            </div>
            <h1 className="section-animate mt-6 font-display text-4xl sm:text-5xl font-bold tracking-tight text-maison-brun">
              Mentions légales & confidentialité
            </h1>
            <p className="section-animate mt-4 text-maison-cacao/75 max-w-2xl">
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-4 gap-10">
                ...
                {SECTIONS.map((s) => {
                  ...
                  return (
                    <li key={s.id}>
                      <a
                        href={`#${s.id}`}
                        className="flex items-center gap-2 text-maison-cacao/80 hover:text-maison-brun text-sm transition-colors"
                      >
                        <Icon className="w-4 h-4 text-maison-brun/70 shrink-0" />
                        {s.label}
                      </a>
                    </li>
                  );
          ...
          {/* Contenu */}
          <div className="lg:col-span-3 space-y-12 text-maison-cacao/85 leading-relaxed">
            <article id="editeur">
              <h2 className="font-display text-2xl text-maison-cacao">1. Éditeur du site</h2>
              <div className="mt-4 space-y-2">
                <p>
                  <strong className="text-maison-cacao">Taskmout</strong> — entreprise artisanale spécialisée
                  dans les huiles, l&apos;amlou et le miel.
                </p>
                <ul className="text-maison-cacao/80 list-disc pl-5 space-y-1">
                  <li>Adresse : 43 rue Clovis Chezel, 51100 Reims, France</li>
                  <li>
                    Email :{' '}
                    <a href="mailto:contact@taskmout.fr" className="text-maison-brun hover:text-maison-brun">
                      contact@taskmout.fr
                    </a>
                  </li>
            ...
            <article id="hebergement">
              <h2 className="font-display text-2xl text-maison-cacao">2. Hébergement</h2>
              <p className="mt-4">
                Le site est hébergé par <strong className="text-maison-cacao">Vercel Inc.</strong> — 340 S Lemon
                Ave #4133, Walnut, CA 91789, USA — <a href="https://vercel.com" className="text-maison-brun hover:text-maison-brun">vercel.com</a>.
            ...
            <article id="donnees">
              <h2 className="font-display text-2xl text-maison-cacao">3. Données personnelles (RGPD)</h2>
              <div className="mt-4 space-y-3">
                ...
                <p className="text-maison-cacao font-medium mt-4">Données collectées</p>
                <ul className="list-disc pl-5 space-y-1 text-maison-cacao/80">
                ...
                <p className="text-maison-cacao font-medium mt-4">Finalité &amp; base légale</p>
                <ul className="list-disc pl-5 space-y-1 text-maison-cacao/80">
                ...
                <p className="text-maison-cacao font-medium mt-4">Durée de conservation</p>
                <ul className="list-disc pl-5 space-y-1 text-maison-cacao/80">
                ...
                <p className="text-maison-cacao font-medium mt-4">Vos droits</p>
                <p className="text-maison-cacao/80">
                  ...
                  <a href="https://www.cnil.fr" className="text-maison-brun hover:text-maison-brun">
                    CNIL
                  </a>
                  .
                </p>

                <p className="text-maison-cacao/80 mt-4">
            ...
            <article id="cookies">
              <h2 className="font-display text-2xl text-maison-cacao">4. Cookies</h2>
              <div className="mt-4 space-y-3">
                <p>
                ...
                <ul className="list-disc pl-5 space-y-2 text-maison-cacao/80">
                  <li>
                    <strong className="text-maison-cacao">Cookies essentiels</strong> — fonctionnement du
                    panier, préférences d&apos;affichage, session administrateur. Toujours actifs car
                    nécessaires.
                  </li>
                  <li>
                    <strong className="text-maison-cacao">Mesure d&apos;audience anonyme</strong> — statistiques
                    agrégées sans identification personnelle. <em>Désactivé par défaut</em>, soumis à
                    consentement.
                  </li>
                  <li>
                    <strong className="text-maison-cacao">Aucune publicité, aucun traceur tiers.</strong>
                  </li>
                </ul>
                <p className="text-maison-cacao/80">
            ...
            <article id="pi">
              <h2 className="font-display text-2xl text-maison-cacao">5. Propriété intellectuelle</h2>
              <p className="mt-4">
            ...
            <article id="cgv">
              <h2 className="font-display text-2xl text-maison-cacao">6. Conditions générales de vente</h2>
              <div className="mt-4 space-y-3">
                <p>
                ...
                <p className="text-maison-cacao/65 text-sm italic">
            ...
            <article id="contact">
              <h2 className="font-display text-2xl text-maison-cacao">7. Contact & réclamations</h2>
              <p className="mt-4">
                ...
                ou via la page{' '}
                <Link href="/contact" className="text-maison-brun hover:text-maison-brun">
                  Contact
                </Link>
                . Nous nous engageons à vous répondre sous 30 jours.
              </p>
              <p className="mt-3 text-maison-cacao/55 text-sm">
